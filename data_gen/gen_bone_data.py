...
# NOTE:
# NOTE: This script is modified from 2s-AGCN for generating bone data
# NOTE: To generate bone data for DGNN, modify the below edges for your dataset
# NOTE: so that the direction is correct
# NOTE:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Bone data generation for NTU/Kinetics')
